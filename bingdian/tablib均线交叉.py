# coding=utf-8
from template.CtaTemplate import *
import template.quickFuncion as qf
import talib as ta


class ma_cross_algo(CtaTemplate):
    def __init__(self):
        print "macross__init__"
        CtaTemplate.__init__(self)
        self.clientID = "macross"
        self.clientMT=[("clientid",self.clientID)]
        
        self.algoMulti=True#多策略运行于同一合约, 仓位/订单均独立,不与网关同步,仅接收myTaskData; 注意同一合约保持一致
        self.symbol = "ag1612"
        self.exchange = "SHFE"
